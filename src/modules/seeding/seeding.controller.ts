...
export class SeedingController {
  ...
  @ApiOperation({ 
    ...
    description: 'Limpia la base de datos y la llena con datos iniciales para desarrollo y testing. Solo disponible para SUPER_ADMIN y ADMIN.'
  })
  @ApiResponse({ 
    status: 200, 
    ...
    schema: {
      ...
      properties: {
        ...
        message: { type: 'string', example: 'Base de datos inicializada correctamente' },
  ...
  @ApiOperation({ 
    ...
    description: 'Muestra el conteo de registros en las tablas principales para verificar el estado de la base de datos.'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Limpia completamente la base de datos y la vuelve a llenar con datos iniciales. Solo disponible para SUPER_ADMIN.'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiResponse({ 
    status: 403, 
    description: 'Acceso denegado - Solo SUPER_ADMIN puede resetear la base de datos' 
  })
  async resetDatabase() {
    return await this.seedingService.seedDatabase();
  }
