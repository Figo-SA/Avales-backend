...
// Helper function to generate random number of athletes (0-8)
const randomAthletes = () => Math.floor(Math.random() * 9); // 0 to 8

// Helper function to generate random number of coaches (0-3)
const randomCoaches = () => Math.floor(Math.random() * 4); // 0 to 3
...
export const eventosSeed = [
  // Eventos DISPONIBLES
  {
    ...
    numEntrenadoresHombres: randomCoaches(),
    numEntrenadoresMujeres: randomCoaches(),
    numAtletasHombres: randomAthletes(),
    numAtletasMujeres: randomAthletes(),
